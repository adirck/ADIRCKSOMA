...
-- FELIPE SILVA   - (SS02) - 22/03/2016 - ENCERRA A SAÍDA CASO A NOTA FISCAL JÁ TENHA SIDO EMITIDA.*/
/* Tiago Carvalho (SS) : 29/01/2016 - Não deixo encerrar a saída sem nota fiscal caso */
...
begin
  ...
  ------SOMA - removido 
	--/*SS02 - ENCERRA A SAÍDA CASO A NOTA FISCAL JÁ TENHA SIDO EMITIDA.*/
